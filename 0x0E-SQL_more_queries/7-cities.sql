...
CREATE TABLE IF NOT EXISTS 'cities'(id INT PRIMARY KEY AUTO_INCREMENT, state_id INT NOT NULL, CONSTRAINT cities_ibfk_1 FOREIGN KEY(state_id) REFERENCES states(id), name VARCHAR(256) NOT NULL); 
